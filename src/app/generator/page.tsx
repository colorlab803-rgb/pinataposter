    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center px-4">
      ...
      <div className="max-w-md w-full relative z-10 text-center space-y-8">
        <div className="space-y-4">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center mx-auto shadow-lg shadow-purple-500/25">
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 space-y-4 backdrop-blur-sm">
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-6 py-3.5 rounded-xl font-semibold text-gray-900 bg-white hover:bg-gray-100 transition-all hover:scale-[1.02] active:scale-[0.98] shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-sm text-purple-300/60 hover:text-purple-200 transition-colors"
        >
