...
export const metadata: Metadata = {
  ...
  description:
    'Sube tu imagen, define el tamaño en centímetros y descarga un PDF dividido en hojas carta, oficio, tabloide, A4 o A3. Gratis, sin registro y sin marca de agua. Ideal para moldes de piñatas, patrones y pósters.',
  alternates: {
    canonical: '/generator',
  },
  openGraph: {
